// Firebase web config — read from NEXT_PUBLIC_FIREBASE_* env vars.
//
...
// If the env is unset the app runs in "no backend" mode (firebaseConfigured
// is false) so a fresh clone still builds and renders.
